...
export default function GetMe() {
  return (
    <Block token={'touch-cv'} heading="get in touch" className="space-y-4">
      <Text>
        Want to hire me? Got a question or need an app? Feel free to{' '}
        ...
        <Link target="_blank" href="https://www.google.com/search?q=Daffa+Putera+Kouseina" className="text-white">
          @kouseina
        </Link>
      </Text>
