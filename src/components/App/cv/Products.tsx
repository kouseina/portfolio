...
const productsData = {
  heading: 'projects',
  text: 'Explore some of the <span class="text-white">projects</span> I have worked on, showcasing my expertise and creativity in development. Here are a few examples.',
}
...
export default async function Products() {
  ...
  if (!works || !projects) {
    return <mark>There is no data</mark>
  }
